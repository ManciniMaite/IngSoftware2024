        ...
        <div className={`sidebar ${isVisible ? 'visible' : 'hidden'}`}>
            ...
            {isVisible && (
                ...
                <ul>
                    ...
                    {isLoggedIn && (( user.rol?.nombre === 'usuario') || hasRole('usuario')) &&  (
                        <>
                             <li>
                                <Link to="/"> {/* Cambia aquí a "/" para el enlace de Inicio */}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/pedidos">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="logo-pedido" viewBox="0 0 16 16">
                    ...
                    {isLoggedIn && ((user.rol?.nombre === 'admin') || hasRole('admin')) && (
                        <>
                            <li>
                                <Link to="/"> {/* Cambia aquí a "/" para el enlace de Inicio */}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
                            ...
                            <li>
                                <Link to="/estadisticasHome"> {/* Cambia aquí a "/" para el enlace de Inicio */}
